...
pub mod kivo_yield_program {
    ...
    pub fn handle_intialize_passive_lending_account(ctx: Context<InitializePassiveLendingAccount>, bump: u8) -> Result<()> {
        ...
        // let lending_account = &mut ctx.accounts.passive_lending_account;
